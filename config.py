...
- "status do sistema" ou "sentido aranha": Ativa o scan interno para monitorizar a CPU e a RAM em tempo real, descobrindo que programa está a consumir mais recursos.
